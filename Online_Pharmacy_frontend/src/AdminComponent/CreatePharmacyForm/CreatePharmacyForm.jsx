...
import { createPharmacy } from '../../component/State/Pharmacy/Action';
const initialValues={
    name:"",
    description:"",
    streetAddress:"",
...
const CreatePharmacyForm = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            dispatch(createPharmacy({data, token:jwt}))
        }
    });
                                ...
                                <div className='relative'>
                                    <img 
                                        ...
                                        onClick={()=>handleRemoveImage(index)}>
                                            <CloseIcon sx={{fontSize:"1rem"}}></CloseIcon>
                                        </IconButton>
