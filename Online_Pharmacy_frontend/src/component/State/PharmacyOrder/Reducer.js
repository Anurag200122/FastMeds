...
const pharmacyOrderReducer=(state=initialState, action)=>{
    switch (action.type){
        case GET_PHARMACY_ORDER_REQUEST:
        case UPDATE_ORDER_STATUS_REQUEST:
            return{
                ...state,
                loadinng:true,error:null
            };
        case GET_PHARMACY_ORDER_SUCCESS:
            return{
        ...
        case GET_PHARMACY_ORDER_FAILURE:
...
export default pharmacyOrderReducer;